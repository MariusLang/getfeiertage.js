...
test('get Weiberfastnacht', () => {
  expect(Feiertage.getWeiberfastnacht(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-02-24`).valueOf());
...
test('get Rosenmontag', () => {
  expect(Feiertage.getRosenmontag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-02-28`).valueOf());
  expect(Feiertage.getRosenmontag(Feiertage.formatDE, year)).toBe(`28.02.${year}`);
});

test('get Fastnachtsdienstag', () => {
  expect(Feiertage.getFastnachtsdienstag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-03-01`).valueOf());
  expect(Feiertage.getFastnachtsdienstag(Feiertage.formatDE, year)).toBe(`01.03.${year}`);
});

test('get Aschermittwoch', () => {
  expect(Feiertage.getAschermittwoch(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-03-02`).valueOf());
...
test('get Gründonnerstag', () => {
  expect(Feiertage.getGruendonnerstag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-04-14`).valueOf());
  expect(Feiertage.getGruendonnerstag(Feiertage.formatDE, year)).toBe(`14.04.${year}`);
});

test('get Karfreitag', () => {
  expect(Feiertage.getKarfreitag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-04-15`).valueOf());
  expect(Feiertage.getKarfreitag(Feiertage.formatDE, year)).toBe(`15.04.${year}`);
});

test('get Ostersonntag', () => {
  expect(Feiertage.getOstersonntag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-04-17`).valueOf());
  expect(Feiertage.getOstersonntag(Feiertage.formatDE, year)).toBe(`17.04.${year}`);
});

test('get Ostermontag', () => {
  expect(Feiertage.getOstermontag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-04-18`).valueOf());
...
test('get Christi Himmelfahrt', () => {
  expect(Feiertage.getChristiHimmelfahrt(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-05-26`).valueOf());
  expect(Feiertage.getChristiHimmelfahrt(Feiertage.formatDE, year)).toBe(`26.05.${year}`);
});

test('get Pfingstsonntag', () => {
  expect(Feiertage.getPfingstsonntag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-06-05`).valueOf());
  expect(Feiertage.getPfingstsonntag(Feiertage.formatDE, year)).toBe(`05.06.${year}`);
});

test('get Pfingstmontag', () => {
  expect(Feiertage.getPfingstmontag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-06-06`).valueOf());
  expect(Feiertage.getPfingstmontag(Feiertage.formatDE, year)).toBe(`06.06.${year}`);
});

test('get Fronleichnam', () => {
  expect(Feiertage.getFronleichnam(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-06-16`).valueOf());
...
test('get Buß und Bettag', () => {
  expect(Feiertage.getBussUndBettag(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-11-16`).valueOf());
...
test('get 1. Advent', () => {
  expect(Feiertage.getAdvent1(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-11-27`).valueOf());
  expect(Feiertage.getAdvent1(Feiertage.formatDE, year)).toBe(`27.11.${year}`);
});

test('get 2. Advent', () => {
  expect(Feiertage.getAdvent2(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-12-04`).valueOf());
  expect(Feiertage.getAdvent2(Feiertage.formatDE, year)).toBe(`04.12.${year}`);
});

test('get 3. Advent', () => {
  expect(Feiertage.getAdvent3(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-12-11`).valueOf());
  expect(Feiertage.getAdvent3(Feiertage.formatDE, year)).toBe(`11.12.${year}`);
});

test('get 4. Advent', () => {
  expect(Feiertage.getAdvent4(Feiertage.formatDateObj, year).valueOf()).toBe(new Date(`${year}-12-18`).valueOf());
